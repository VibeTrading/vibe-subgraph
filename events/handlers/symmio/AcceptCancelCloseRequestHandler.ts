import {AcceptCancelCloseRequest as AcceptCancelCloseRequestEntity} from "../../../generated/schema"
    ...
    handle(_event: ethereum.Event, version: Version): void {
        ...
        switch (version) {
            case Version.v_0_8_4: {
                // @ts-ignore
                const e = changetype<AcceptCancelCloseRequest_8_4>(_event)
                entity.closeId = e.params.closeId
                break
            }
            case Version.v_0_8_3: {
                // @ts-ignore
                const e = changetype<AcceptCancelCloseRequest_8_3>(_event)
                entity.closeId = e.params.closeId
                break
            }
            default: {
